...
const DashboardPage = () => {
  ...
  const loadDashboard = async (userId) => {
    try {
      ...
      const res = await fetch(`https://datadoor.onrender.com/api/v1/data/user-dashboard/${userId}`, {
        headers: {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
            {getTimeGreeting()}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-cyan-600">{userName}</span>! 👋
          </h1>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm font-semibold text-teal-600">8:00 AM - 9:00 PM</p>
        ...
        <div className="mb-6">
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 sm:p-6">
            ...
            <button
              onClick={goToTopup}
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-lg hover:from-teal-700 hover:to-cyan-700 transition-all shadow-md hover:shadow-lg text-sm font-medium w-full sm:w-auto justify-center"
            >
