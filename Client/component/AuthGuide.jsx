      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <div className="relative w-20 h-20 mx-auto mb-8">
            ...
            <div className="absolute inset-0 rounded-full border-3 border-transparent border-t-teal-600 dark:border-t-teal-500 animate-spin"></div>
            ...
            {/* Pulse effect */}
            <div className="absolute inset-0 rounded-full bg-teal-600/20 dark:bg-teal-500/20 animate-ping"></div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                Your Gateway to Data Services
              </p>
            </div>
            
            <div className="flex items-center justify-center space-x-2.5 text-slate-700 dark:text-slate-300">
              <Loader2 className="w-4 h-4 animate-spin text-teal-600 dark:text-teal-500" strokeWidth={2.5} />
          ...
          <div className="mt-10 w-64 mx-auto">
            <div className="h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
              <div className="h-full bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 rounded-full animate-progress shadow-sm"></div>
            </div>
          </div>
