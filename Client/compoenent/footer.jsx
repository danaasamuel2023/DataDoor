      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-9 h-9 bg-gradient-to-br from-teal-600 to-cyan-600 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/20">
                  <Database className="w-4.5 h-4.5 text-white" strokeWidth={2.5} />
                </div>
                <h2 className="text-xl font-bold text-white tracking-tight">
                  Data<span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-400">Door</span>
                </h2>
              </div>
              <p className="text-slate-400 text-sm leading-relaxed mb-5">
                Your gateway to seamless mobile data services across Ghana. Fast, reliable, and affordable.
              </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                { name: 'About DataDoor', path: '/about' },
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-slate-400 text-sm font-medium">
                © {new Date().getFullYear()} DataDoor. All rights reserved.
              </p>
            </div>
