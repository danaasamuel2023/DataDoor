...
const MobileNavbar = () => {
  ...
  const NavItem = ({ icon, text, path, onClick, disabled = false, badge = null, isActive = false }) => {
    const itemClasses = `flex items-center py-3.5 px-5 ${
      ...
      isActive ? 'bg-gradient-to-r from-teal-50 to-transparent dark:from-teal-950/30 dark:to-transparent border-l-4 border-teal-600 dark:border-teal-500' : ''
    }`;
    ...
    return (
      ...
      >
        <div className={`mr-3.5 ${isActive ? 'text-teal-600 dark:text-teal-500' : 'text-slate-500 dark:text-slate-400'}`}>
        ...
        {badge && (
          <span className="px-2.5 py-1 text-xs font-semibold bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-md shadow-sm">
            {badge}
          </span>
        )}
        {disabled && (
      ...
      <header className="fixed top-0 left-0 w-full bg-white dark:bg-slate-900 shadow-sm z-40 border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="flex justify-between items-center h-16 px-5 max-w-screen-xl mx-auto">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-gradient-to-br from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30">
      ...
      >
        ...
        <div className="border-b border-slate-200 dark:border-slate-800">
          <div className="flex justify-between items-center px-5 py-4">
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 bg-gradient-to-br from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/20">
          ...
          {isLoggedIn && (
            <div className="px-5 pb-4">
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-teal-500/30">
            ...
            <div className="p-6 flex flex-col items-center justify-center h-full">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                  Your gateway to seamless mobile data services in Ghana
                </p>
              </div>
              ...
              <div className="w-full space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 text-white rounded-xl hover:from-teal-700 hover:to-cyan-700 dark:hover:from-teal-600 dark:hover:to-cyan-600 transition-all duration-200 font-semibold text-sm shadow-lg shadow-teal-500/30"
                >
                  Sign In to Account
                </button>
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-white dark:bg-slate-800 text-teal-600 dark:text-teal-400 border-2 border-teal-600 dark:border-teal-500 rounded-xl hover:bg-teal-50 dark:hover:bg-slate-700 transition-all duration-200 font-semibold text-sm shadow-sm"
                >
                  Create New Account
                </button>
              </div>
              ...
              <div className="mt-10 text-center">
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                  © 2025 DataDoor. All rights reserved.
                </p>
              </div>
            </div>
          )}
