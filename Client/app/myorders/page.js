      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="text-center">
          <div className="relative w-20 h-20 mx-auto mb-6">
            ...
            <div className="absolute inset-3 rounded-xl bg-gradient-to-br from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 flex items-center justify-center shadow-lg">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md border border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 bg-teal-100 dark:bg-teal-900/30 rounded-xl">
                <Activity className="w-6 h-6 text-teal-600 dark:text-teal-400" strokeWidth={2} />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-4 w-full sm:w-auto">
              <div className="flex items-center space-x-3">
                ...
                <select
                  className="border border-slate-300 dark:border-slate-600 rounded-xl py-2.5 px-4 text-slate-900 dark:text-white bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm font-medium"
                  value={statusFilter}
            ...
            <button 
              ...
              className="flex items-center space-x-2 bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 text-white px-5 py-2.5 rounded-xl hover:from-teal-700 hover:to-cyan-700 dark:hover:from-teal-600 dark:hover:to-cyan-600 transition-all text-sm font-bold shadow-lg hover:shadow-xl shadow-teal-500/30"
            >
                    ...
                    <td colSpan={6} className="px-6 py-12 text-center">
                      <div className="flex justify-center">
                        <div className="relative w-8 h-8">
                          ...
                          <div className="absolute top-0 w-8 h-8 rounded-full border-2 border-transparent border-t-teal-600 dark:border-t-teal-500 animate-spin"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                              ...
                              className={`inline-flex items-center px-4 py-2 border rounded-xl text-sm font-bold transition-all shadow-sm ${
                                expired
                                  ...
                                  : verifyingId === transaction._id
                                    ? 'border-teal-300 dark:border-teal-700 text-teal-700 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30'
                                    : 'border-teal-600 dark:border-teal-500 text-teal-600 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500'
                              }`}
        ...
        {pagination.pages > 1 && (
          <div className="flex items-center justify-between mt-6 px-4">
            <div className="text-sm font-semibold text-slate-700 dark:text-slate-300">
              Showing page <span className="text-teal-600 dark:text-teal-400">{pagination.page}</span> of{' '}
              <span className="text-teal-600 dark:text-teal-400">{pagination.pages}</span>
            </div>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm font-bold transition-all ${
                        pagination.page === pageNum
                          ? 'bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-500 dark:to-cyan-500 text-white shadow-lg shadow-teal-500/30'
